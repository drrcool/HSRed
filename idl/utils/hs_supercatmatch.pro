PRO hs_supercatmatch, mapfile, bootes=bootes, aiz=aiz, fls=fls, sdss2=sdss2
  ...
  if keyword_set(bootes) then begin
     ...
     ;;Read the targets
     readcol, catalog, ra, dec, type, rank, rmag, rapmag, $
        bcode, icode, rcode, junk, junk,junk, format='D,D,A,D,D,D,A,L,L,A,A,A'
  
  
  ;;Read the skies
  
     readcol, catalog+'_sky', ras, decs, junk, junk, junk, junk,junk1, $
        format='D,D,A,A,A,A,A'
...
;;Read the targets
  readcol, catalog, ra, dec, type, rank, rmag, rapmag,rfiber,icode,junk,$
     format='D,D,A,D,D,D,D,D,A'
...
;;Read the targets
  readcol, catalog, ra, dec, type, rank, bcode, rmag, rapmag,icode, $
     format='D,D,A,D,A,D,D,A'
...
k = where(strmatch(target1,'sky*') eq 0l or $
...
readcol, mapfile, fiber1, junk, target1, ra1, dec1,$
   junk, junk, junk,junk, format='L,A,A,A,A,A,A,A,A'
  
  k = where(strmatch(target1,'unused'), ct)
