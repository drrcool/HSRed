...
PRO COLORBAR, DATARANGE=datarange, BOTTOM=bottom, CHARSIZE=charsize, COLOR=color, DIVISIONS=divisions, $
...
if keyword_set(DATARANGE) then minrange=float(datarange(0))
IF keyword_set(DATARANGE) then maxrange=float(datarange(1))
