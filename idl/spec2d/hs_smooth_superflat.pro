...
;   19-Jun-2014 smoran; removed code to zero-out model
;               beyond the range of validity. better to
;               let it extrapolate a few pixels than deal
;               with the divide-by-zeros later
;-
;------------------------------------------------------------------------------
function hs_smooth_superflat, superflatset, airset, plottitle=plottitle
